...
">
        ...
        <form action="/search_all_bhajans.php">
            <fieldset>
                <legend>List All Bhajans</legend>
                <div class="form-group">
                    <button id="submit" name="submit" class="btn-primary" style="width: 45%">List All Bhajans</button>
                </div>
            </fieldset><br>
        </form>
...
##################################################### -->
        ...
        <form action="/seating.php">
            <fieldset>
                ...
                <div class="form-group">
                    <button id="submit" name="submit" class="btn-primary" style="width: 35%">Enter the singers</button>
                </div>
            </fieldset><br>
        </form>
        ...
        <form action="/add_bhajan.php">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input id="newbhajan" name="newbhajan" type="text" placeholder="Enter the name of the bhajan" required style="width: 47%; padding: 8px; font-family: monospace;
"><br>
                </div>
                <div class="form-group">
