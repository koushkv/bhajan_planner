...
<head>
    ...
    var warning = document.getElementById("deity-warning");
...
<form action="/generate_link.php">
        ...
        <form action="/edit_message.php">
            <fieldset>
            <legend>Post a message</legend>
                    <button id="submit" name="submit" class="btn-primary-mob">Compose</button>
            </fieldset><br>
        </form>
